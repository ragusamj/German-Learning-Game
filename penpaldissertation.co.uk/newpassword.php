...
<body id="page-top" class="index">
  ...
  <div class="form">
    ...
    <!--  <input type="text" placeholder="Name"onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'"required/> -->
	 <input type="password" name="oldpwd" placeholder="Old Password"onfocus="this.placeholder = ''" onblur="this.placeholder = 'Old Password'"required/>
      <input type="password" name="newpwd" placeholder="New Password"onfocus="this.placeholder = ''" onblur="this.placeholder = 'New Password'"required/>
	   <input type="password" name="newconfirmpwd" placeholder="Confirm Password"onfocus="this.placeholder = ''" onblur="this.placeholder = 'Confirm Password'"required/>
